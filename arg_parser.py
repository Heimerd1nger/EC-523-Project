...
##################################### Unlearner ############################################
    ...
    # SCRUB
    parser.add_argument('--sgda_epochs', type=int, default=7, help='Number of epochs for SGDA')
    parser.add_argument('--sgda_learning_rate', type=float, default=0.0005, help='Learning rate for SGDA')
    ...
    parser.add_argument('--msteps', type=int, default=7, help='Number of steps for something')
